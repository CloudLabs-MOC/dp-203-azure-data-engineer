...
### Task-4: Create an input for the event data stream
...
### Task-5: Create an output for the Power BI workspace
...
### Task-6: Create a query to summarize the event stream
...
### Task-8: Visualize the streaming data in Power BI
